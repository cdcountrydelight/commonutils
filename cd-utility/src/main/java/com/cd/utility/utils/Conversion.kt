...
inline fun dpToPx(dp: Float): Float {
...
inline fun <T> convertNoKeyJsonToList(jsonObject: JsonObject?, createItem: (Int, String) -> T): List<T> {
    ...
    return try {
        ...
        while (iterator.hasNext()) {
            ...
            val containersItem = createItem(key.toInt(), value)
